...
class MailPgsqlSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        //     MailPgsql::updateOrCreate(['id' => $mail['id']], $mail);
        // }

        DB::connection('pgsql')->table('mails')->delete();
        DB::connection('pgsql')->table('mails')->insert($mails);
    }
}
